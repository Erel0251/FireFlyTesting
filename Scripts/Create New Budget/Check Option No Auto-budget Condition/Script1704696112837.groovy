...
WebUI.setText(findTestObject('Object Repository/Create New Budget/Page_Create a new budget  Budgets  Firefly III/input_name'), 'Games')

WebUI.click(findTestObject('Object Repository/Create New Budget/Page_Create a new budget  Budgets  Firefly III/input_create_another'))
...
WebUI.verifyElementInViewport(findTestObject('Object Repository/Create New Budget/Page_Create a new budget  Budgets  Firefly III/div_CloseSuccessStored new budget Toys'), 
    0)
