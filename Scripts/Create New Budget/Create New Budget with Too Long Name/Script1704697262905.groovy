...
WebUI.setText(findTestObject('Object Repository/Create New Budget/Page_Create a new budget  Budgets  Firefly III/input_name'), 
    'Morbi eleifend odio eu risus tristique ultricies. Nulla facilisi. Curabitur a velit quis ex luctus ullamcorper. Donec porta lectus ac velit varius, ac consequat orci dapibus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per volutpat. ')
...
WebUI.verifyElementInViewport(findTestObject('Create New Budget/Page_Create a new budget  Budgets  Firefly III/p_The name may not be greater than 255 characters'), 
    0)
