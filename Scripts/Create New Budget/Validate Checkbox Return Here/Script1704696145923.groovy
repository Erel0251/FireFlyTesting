...
WebUI.verifyElementInViewport(findTestObject('Object Repository/Create New Budget/Page_Create a new budget  Budgets  Firefly III/p_The name field is required'), 
    0)
